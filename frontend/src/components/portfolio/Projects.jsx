        ...
        {PROJECTS.map((p, i) => (
          <Reveal key={p.title} delay={i * 0.05}>
            <article
              ...
              className="group rounded-2xl border border-white/10 bg-white/[0.02] p-7 transition-colors duration-300 hover:border-blue-500/40 md:p-9"
            >
              <div className="flex items-center justify-between">
                <span className="font-display text-5xl font-bold text-white/10">{p.index}</span>
