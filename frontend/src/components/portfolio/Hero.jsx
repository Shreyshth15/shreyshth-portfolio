...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* contrast guard so the headline stays sharp over the texture */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_28%_46%,rgba(3,7,18,0.55),transparent_62%)]" />
