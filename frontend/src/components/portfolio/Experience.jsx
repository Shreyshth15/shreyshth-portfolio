...
export default function Experience() {
  return (
    <SectionShell id="experience" number="03 / Experience" title={<>Professional <span className="font-serif italic text-blue-400">Experience</span></>} data-testid="experience-section" motif="yield">
